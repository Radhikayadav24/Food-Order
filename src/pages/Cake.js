...
function Cake() {
  ...
  const [Cards, setCards] = useState([
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRNboPSkQ-DKNoRVPiIDvaIc0_giypcM1ekyA&usqp=CAU",
      name: "Clinkers Cake  ",
    ...
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRcGWgLtGr0Hdd-bytidtpou52JgfVJItcDfg&usqp=CAU",
    ...
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQc3tJeuPrJ58Fn5q9ZvlUqehOMpp3Ra4SDlw&usqp=CAU",

      name: "Polyviou's fairy bread Cake ",
    ...
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT9f0IQEByDmf81Glb-AQHURZv9ww5K9wQZ7g&usqp=CAU",
    ...
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR9qrhwMoc8l37pnKMk5OUp0rPK9okKJQuq7A&usqp=CAU",
    ...
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRY1gTYNEOGeV5EPUkphtVZ0mLFJC-7T-yvCQ&usqp=CAU",
      name: " Teddy Birthday Cake",
    ...
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTARYD09Kt6OM0L_EFpn7YU3GR8ChfARyYoGA&usqp=CAU",

      name: "Rainbow Sprinkle Pinata Cake",
      Address: "  South Tukoganj",
      foodcategory: "Pure Veg ",
      Price: "250",
      Rating: "3.5 •",
    ...
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSzpS1ACFOViIRHNOpaWmADClaLcciyr8EY8A&usqp=CAU",

      name: "Sofft Vanilla Cake ",
      Address: "  Khajarana",
      foodcategory: "Non-Veg ",
      Price: "350",
      Rating: "5 •",
    ...
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQkCj_9YyxWYxSGJcLV5mpGEx7xMmjLCsXJDg&usqp=CAU",

      name: "Christmas Cake",
      Address: "New palasia ",
    },
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTZn6z9L3Mkb1bwBUlsuPEoQdpE5hmYnK2LIg&usqp=CAU",
  ...
  return (
    <>
      <div className="mmm">
        <h1 className="pizza">Cake</h1>
        <p className="parap">
          Cheesilicious Cake to make every day extraordinary.
        </p>
        <div className="btnp">
          <button
