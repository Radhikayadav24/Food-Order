...
function NorthIndian(){
  ...
  const handleCloseModal = () => {
    ...
    const  [Cards, setCards] = useState( [ 
        {
          src: "https://cdn2.hubspot.net/hubfs/546379/Thali.jpg",
          name: "Rogan Josh ",
        ...
        {
          src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRWWKCkLunnEnMsuRiQ_As5LZLT-P2iWhrcvw&usqp=CAU",
        ...
        {
          src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT6uAGRkC-NMKP__yLyGMuXNFLRiTj9CebFQ1tQG2Qo8lb7ZknzP8sm7OsnloEUUlTNbgo&usqp=CAU",
        ...
        {
          src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSBSE4PzTpipkyDlr-1IYPXCpc46shG_E7-aA&usqp=CAU",
    
          name: "Karaikudi Curry. ",
          Address: "  old palasia",
          foodcategory: "Pure Veg ",
          Price: "600",
          Rating: "4.5 •",
        ...
        {
          src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQObwKQccfiPqMnpp1Dh529FgigOdqlYJgFOQ&usqp=CAU",
      ...
      Time: "20-30 mins",
        ...
        {
          src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ2Qq0OlBKS8Urw3w-PA4gwXZRyX4DYtUCujQ&usqp=CAU",
        ...
        {
          src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRw3VbPHxXg24AeJ46haRECUPvE2TwovTrBDw&usqp=CAU",
        ...
        {
          src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSBjGymgiHh_RTJurB3ZOO1dkXaCYjHSL5_rg&usqp=CAU",
        ...
        {
          src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSvxFaw12OWt-y0eIkyzleqctbGUfU3QrY0ng&usqp=CAU",
    
          name: "Double chesse AAlu paratha ",
          Address: " Vijay Nagar",
          foodcategory: "Pure Veg ",
          Price: "250",
          Rating: "5 •",
  ...
  const filteredVegNonVegCards = Cards.filter((card) => {
    ...
    return(
        <>
        <div className="mmm">
        <h1 className="pizza">NorthIndian</h1>
        <p className="parap">
          Cheesilicious NorthIndian to make every day extraordinary.
        </p>
        <div className="btnp">
          <button
