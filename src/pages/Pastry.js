...
function Pastry() {
  ...
  const  [Cards, setCards] = useState( [ 
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRIQj_5Dircl6nHkAzo0AgBPMuM0aCL1LXsPw&usqp=CAU",
    ...
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQx__E7BOPN9fvjAUkVLpHXZHuJIxl0oBQtYu4TC6nOFusj-XkDwBUcpt-ZB4sigmnDzSI&usqp=CAU",
    ...
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQaixb2GJdw8G8ILVn87NjOFRODFz1tbMm4_g&usqp=CAU",
    ...
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSljlYGotnOw_xUg8u7pmGnjvLmHqRBGa_RoA&usqp=CAU",
    ...
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQjn-P8EgOqr5-IxJI5LsflYjVJCB3LKwW-4w&usqp=CAU",
    ...
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRdq3-ofLLu5Qs1cQbEsu_rx21UOv3QTBjtJw&usqp=CAU",
    ...
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ5ov9poy0_crG62hK_i2qCv8SE6lt8eAKrPw&usqp=CAU",

      name: "Blanckberry Jam  Pastry ",
      Address: "  South Tukoganj",
      foodcategory: "Non-Veg ",
      Price: "450",
      Rating: "3.5 •",
    ...
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQso55Od7QV3cDdNVnNe9-lvUJpWR3jA0ysUA&usqp=CAU",

      name: "chocolate brownie Pastry ",
      Address: "  Khajarana",
      foodcategory: "Non-Veg ",
          Price: "350",
          Rating: "5 •",
    ...
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSWfYssaBJ-UONdllDiufKlO3-VHJYzJxVDFg&usqp=CAU",
    ...
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTdvAV2wmFOXv_fhE7miZMCuvUMmJJNdkfFuQd1s2Bf2j_kN9uHnmkP2fBCKX_cKtRrms0&usqp=CAU",

      name: "Pineappple Pastry",
      Address: " Vijay Nagar",
      foodcategory: "Pure Veg ",
      Price: "50",
      Rating: "5 •",
  ...
  return (
    <>
        <div className="mmm">
        <h1 className="pizza">Pastry</h1>
        <p className="parap">
          Cheesilicious Pastry to make every day extraordinary.
        </p>
        <div className="btnp">
          <button
