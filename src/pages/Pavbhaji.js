...
function Pavbhaji() {
  ...
  const  [Cards, setCards] = useState( [ 
    ...
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ7yh1nfEZIDe8_AZ7nsnRlTseiqPsFeHR9DQ&usqp=CAU",
    ...
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTm2jLUBY00VPkg6ORV_rIamMMNOoqkg6X7dA&usqp=CAU",
    ...
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTG1u0AixsdVEbJK8lWH6qs-Iy05UXPLZpqzg&usqp=CAU",
    ...
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS1zmfapNwOM7OeNtpQKg5G_jCrABGkrqrWjg&usqp=CAU",

      name: "Masala pavbhaji ",
      Address: "  Roy's Rolls ",
      foodcategory: "Pure Veg ",
      Price: "250",
      Rating: "4.2 •",
    ...
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT6X1ZMb9OSc1fs5EvigYViKzFmahLhWtvjeg&usqp=CAU",
      name: " Butter Masala Pavbhaji",
    ...
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8hqP0buXPeKqyk9EQ_yg8cYYvmSvH8mpTAg&usqp=CAU",
    ...
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTI71vOAz0Pp3P5GZAHDzsqB5C7I9CNTpr3gUnBtagIcb5IMrZgKsiUmiwzL9s6vx8GnZk&usqp=CAU",

      name: "Red Sauce Pavbhaji ",
      Address: "  Khajarana",
      foodcategory: "Non-Veg ",
          Price: "350",
          Rating: "5 •",
    ...
    {
      src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQrjU7z9ANeZofVRQA_U5i-_67I2_adkD_AFw&usqp=CAU",

      name: "Chinese Veg Pavbhaji",
      Address: "New palasia ",
      foodcategory: "Pure Veg ",
      Price: "250",
      Rating: "5 •",
  ...
  return (
    <>
        <div className="mmm">
        <h1 className="pizza">Pavbhaji</h1>
        <p className="parap">
          Cheesilicious Pavbhaji to make every day extraordinary.
        </p>
        <div className="btnp">
          <button
